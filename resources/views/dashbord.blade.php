...
<body class="bg-light">
    ...
    <div class="app-body d-flex h-100">
        ...
        <main class="main flex-grow-1">
            <nav style="margin-left: 12px;" aria-label="breadcrumb">
            ...
            <div class="content p-3">
                ...
                <div>
                    ...
                    <div class="table-container" style="background: #f8fafc; padding: 10px; border-radius: 10px;">
                        <table id="dataTable" class="table table-sm table-hover border" style="font-family: 'Segoe UI', sans-serif; font-size: 14px; background: white; border-radius: 8px; overflow: hidden;">
                            <thead>
                                <tr style="text-transform: uppercase; font-size: 13px; height: 45px;">
                                    <th class="text-center" style="width: 40px; background: linear-gradient(90deg, #3b82f6, #2563eb); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0;">🔢</th>
                                    <th style="background: linear-gradient(90deg, #2563eb, #1d4ed8); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">📦 Name</th>
                                    <th style="background: linear-gradient(90deg, #1d4ed8, #1e40af); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">🔧 Model</th>
                                    <th style="background: linear-gradient(90deg, #1e40af, #1e3a8a); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">🔐 Serial</th>
                                    <th style="background: linear-gradient(90deg, #1e3a8a, #172554); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">📊 Status</th>
                                    <th style="background: linear-gradient(90deg, #172554, #1e3a8a); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: right; padding-right: 15px;">💰 Price</th>
                                    <th style="background: linear-gradient(90deg, #1e3a8a, #1e40af); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: right; padding-right: 15px;">💵 S.Price</th>
                                    <th style="background: linear-gradient(90deg, #1e40af, #1d4ed8); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">🧭 Code</th>
                                    <th style="background: linear-gradient(90deg, #1d4ed8, #2563eb); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">🏢 Office</th>
                                    <th style="background: linear-gradient(90deg, #2563eb, #3b82f6); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">🧑‍💼 Saler</th>
                                    <th style="background: linear-gradient(90deg, #3b82f6, #60a5fa); color: white; border-right: 1px solid rgba(255,255,255,0.1); position: sticky; top: 0; text-align: left; padding-left: 15px;">🧾 TIN</th>
                                    <th style="background: linear-gradient(90deg, #60a5fa, #93c5fd); color: white; position: sticky; top: 0; text-align: center;">📅 S.Date</th>
                                </tr>
                            </thead>
                            <tbody id="tableBody" style="background-color: #f9fafb;">
